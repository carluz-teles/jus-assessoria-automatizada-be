-- Revert 0088: restore the ORIGINAL (0042) unique index exactly, then drop the
...
-- scenario 0088 exists to allow — docs/erd-costura-providencia-tarefa-peca.md §1),
...
-- per intimation_id, then `migrate force 87` before retrying. Do not roll back 0088
