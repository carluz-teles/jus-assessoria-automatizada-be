-- 0079: task.action_item_id — closes the providência → tarefa loop
...
-- (action_item.task_id, migration 0078) on its own table.
--
...
-- migration 0078 notes the same for action_item.task_id.
ALTER TABLE task
