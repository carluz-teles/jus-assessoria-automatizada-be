...
// login performs the SSO authentication against the Keycloak instance and, on success,
// marks the client CONNECTED. The cookie jar captures the session cookies for reuse.
//
